...
public partial class QueryAndModify_journalQueryAndModify : System.Web.UI.Page
{
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        journaltype.SelectedItem.Value = GridView1.Rows[num].Cells[1].Text.ToString();
        grade.SelectedItem.Value = GridView1.Rows[num].Cells[2].Text.ToString();
        major.SelectedItem.Value = GridView1.Rows[num].Cells[3].Text.ToString();
        ...
        periodtype.SelectedItem.Value = GridView1.Rows[num].Cells[7].Text.ToString();
        txtoffname.Text = GridView1.Rows[num].Cells[8].Text.ToString();
        language.SelectedItem.Value = GridView1.Rows[num].Cells[9].Text.ToString();
        txtcn.Text = GridView1.Rows[num].Cells[10].Text.ToString();
        txtperiod.Text = GridView1.Rows[num].Cells[11].Text.ToString();
        status.SelectedItem.Value = GridView1.Rows[num].Cells[12].Text.ToString();
        organ.SelectedItem.Value = GridView1.Rows[num].Cells[13].Text.ToString();
