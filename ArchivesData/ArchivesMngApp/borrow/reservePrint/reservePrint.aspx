<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reservePrint.aspx.cs" Inherits="managers_borrow_reservePrint" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="600px" Width="100%">
            <LocalReport ReportPath="borrow\reservePrint\ReserveReport.rdlc">
                <DataSources>
