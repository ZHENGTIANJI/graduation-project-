<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserInformationPrint.aspx.cs" Inherits="managers_user_manage_UserInformationPrint" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="600px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
            <LocalReport ReportPath="user_manage\UserInformationPrint\UserInformationReport.rdlc">
                <DataSources>
