...
public partial class QueryAndModify_paperQueryAndModify : dropdownlist
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter adpt = new SqlDataAdapter("SELECT [id],[number_of_page], [dabian_dt], [xuezhi], [format],[write_dt],[zhicheng],[adviser], [location], [stock_dt], [name], [ptname], [mname], [QR_code], [class_number],[shenhe],[direction], [author], case when [status]=0 then '库存' when [status]=1 then '预约' else '借出' end status, [note], [lname] FROM [paper] left join paper_type on paper.paper_type_id=paper_type.ptid left join major on paper.major_id=major.mid left join language on paper.language=language.lid where is_delete=0 and name like '%" + strpapername + "%' and mname like '%" + strmajor + "%' and ptname like '%" + strpapertype + "%' and shenhe='已审核'", cnn);
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        if (GridView1.Rows[num].Cells[0].Text.ToString() != GridView1.Rows[num].Cells[1].Text.ToString())
        {
            ...
            txtauthor.Text = GridView1.Rows[num].Cells[2].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[2].Text.ToString();
            ...
            txtdirection.Text = GridView1.Rows[num].Cells[5].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[5].Text.ToString();
            ...
            txtQR.Text = GridView1.Rows[num].Cells[7].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[7].Text.ToString();
            txtlocation.Text = GridView1.Rows[num].Cells[8].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[8].Text.ToString();
            status.SelectedIndex = -1;
            status.Items.FindByText(GridView1.Rows[num].Cells[9].Text.ToString()).Selected = true;
            txtadviser.Text = GridView1.Rows[num].Cells[10].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[10].Text.ToString();
            ...
            txtcn.Text = GridView1.Rows[num].Cells[13].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[13].Text.ToString();
            ...
            txtformat.Text = GridView1.Rows[num].Cells[17].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[17].Text.ToString();
            txtnumberofpage.Text = GridView1.Rows[num].Cells[18].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[18].Text.ToString();
            txtnote.Text = GridView1.Rows[num].Cells[19].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[20].Text.ToString();
            Session["paperid"] = GridView1.Rows[num].Cells[20].Text.ToString();
        }
