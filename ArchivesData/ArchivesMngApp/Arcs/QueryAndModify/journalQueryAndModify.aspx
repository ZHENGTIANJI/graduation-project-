...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:dtcnn %>" SelectCommand="SELECT * FROM [journal]"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:dtcnn %>" SelectCommand="SELECT * FROM [organization]"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:dtcnn %>" SelectCommand="SELECT * FROM [binding_type]"></asp:SqlDataSource>
        <div class="table-a">
             <table style="width:100%;">
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style32">
                    <asp:Label ID="Label7" runat="server" Text="语种"></asp:Label>
                </td>
                <td class="auto-style15">
