...
public partial class QueryAndModify_dataQueryAndModify : dropdownlist
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter adpt = new SqlDataAdapter("SELECT [id],[number_of_page], [compile_dt], [unit], [format], [location], [stock_dt], [number], [name], [dtname], [mname], [QR_code], [class_number], [author], case when [status]=0 then '库存' when [status]=1 then '预约' else '借出' end status, [note], [lname] FROM [data] left join data_type on data.data_type_id=data_type.dtid left join major on data.major_id=major.mid left join language on data.language=language.lid where is_delete=0 and name like '%" + strdataname + "%' and mname like '%" + strmajor + "%' and dtname like '%" + strdatatype + "%'", cnn);
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        if (GridView1.Rows[0].Cells[0].Text.ToString() != GridView1.Rows[0].Cells[2].Text.ToString() && GridView1.Rows[0].Cells[2].Text.ToString() != GridView1.Rows[0].Cells[1].Text.ToString())
        {
            ...
            txtQR.Text = GridView1.Rows[num].Cells[2].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[2].Text.ToString();
            txtunit.Text = GridView1.Rows[num].Cells[3].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[3].Text.ToString();
            ...
            txtlocation.Text = GridView1.Rows[num].Cells[5].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[5].Text.ToString();
            txtnumber.Text = GridView1.Rows[num].Cells[6].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[6].Text.ToString();
            txtcn.Text = GridView1.Rows[num].Cells[7].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[7].Text.ToString();
            ...
            txtformat.Text = GridView1.Rows[num].Cells[10].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[10].Text.ToString();
            txtnumberofpage.Text = GridView1.Rows[num].Cells[11].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[11].Text.ToString();
            txtauthor.Text = GridView1.Rows[num].Cells[12].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[12].Text.ToString();
            ...
            txtnote.Text = GridView1.Rows[num].Cells[15].Text.ToString() == "&nbsp;" ? "" : GridView1.Rows[num].Cells[15].Text.ToString();
